...
async function loadDash() {
  ...
  $id('dash-stats').innerHTML = `
    ...
    <div class="stat" style="--ac:${cajaColor}">
      ...
      <div class="stat-sub">
        ${r.aportes_comprometidos > 0
          ? `Bruto ${fmtM(r.saldo_caja_bruto)} · <span style="color:var(--blue)">−${fmtM(r.aportes_comprometidos)} comprometido en gastos ext.</span>`
          : 'Saldo acumulado + ahorro'}
      </div>
    </div>`;
