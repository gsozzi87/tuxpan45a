...
<div class='modal-ov' id='modal-edit-sit' onclick='closeOv(event,"modal-edit-sit")'><div class='modal'>
  ...
  <div class='form-g'><label class='form-l'>Foto de evidencia (opcional)</label>
    <input class='fi' type='file' id='esit-foto' accept='image/*' capture='environment'>
...
<div class='modal-ov' id='modal-solicitud' onclick='closeOv(event,"modal-solicitud")'><div class='modal'>
  ...
  <div class='form-g'><label class='form-l'>Foto del problema (opcional)</label><input class='fi' id='sol-foto' type='file' accept='image/*' capture='environment'></div>
...
<div class='modal-ov' id='modal-resolver' onclick='closeOv(event,"modal-resolver")'><div class='modal'>
  ...
  <div class='form-g'><label class='form-l'>Foto de resolución / evidencia</label><input class='fi' id='resolver-foto' type='file' accept='image/*' capture='environment'></div>
...
<div class='modal-ov' id='modal-semana' onclick='closeOv(event,"modal-semana")'><div class='modal ml'>
  ...
  <div style='margin-top:10px'><label class='form-l'>Foto de inventario</label><input class='fi' id='sem-insumo-foto' type='file' accept='image/*' capture='environment'></div>
...
<div class='modal-ov' id='modal-elevador' onclick='closeOv(event,"modal-elevador")'><div class='modal mw'>
  ...
  <div class='g3'>
    <div class='form-g'><label class='form-l'>Foto 1</label><input class='fi' id='elev-f1' type='file' accept='image/*' capture='environment'><input class='fi' id='elev-d1' placeholder='Descripción' style='margin-top:5px'></div>
    <div class='form-g'><label class='form-l'>Foto 2</label><input class='fi' id='elev-f2' type='file' accept='image/*' capture='environment'><input class='fi' id='elev-d2' placeholder='Descripción' style='margin-top:5px'></div>
    <div class='form-g'><label class='form-l'>Foto 3</label><input class='fi' id='elev-f3' type='file' accept='image/*' capture='environment'><input class='fi' id='elev-d3' placeholder='Descripción' style='margin-top:5px'></div>
  </div>
